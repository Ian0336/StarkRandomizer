...
const useFetchUnitPoolProp = (ids) => {
    ...
    return {token_pool: tmp, token_pool_prop: tmp2, isLoading:isLoading};
}

export default useFetchUnitPoolProp
